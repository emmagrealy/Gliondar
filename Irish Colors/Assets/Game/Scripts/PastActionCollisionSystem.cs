...
public class PastActionCollisionSystem : MonoBehaviour {
    public AudioClip[] PastAction;
    public AudioSource AS;
    public GameObject FinishUI;
    public Text ScoreText;
    
    private int Score;
    private String[] PastActionNames = {"Walked", "Ate", "Ran", "Slept", "Spoke", "Read"};
    private int Counter;
    private int SetUp;
    ...
    void Start() {
        ...
        this.gameObject.tag = PastActionNames[Counter];
        AS.clip = PastAction[Counter];
        AS.Play();
    }
