...
public class FoodCollisionSystem : MonoBehaviour {
    ...
    private int Score;
    private String[] FoodNames = {"Burger", "Chips", "Chicken", "Salad", "Sandwhich", "Pancake"};
    private int Counter;
    private int SetUp;
    ...
    void Start() {
        ...
        this.gameObject.tag = FoodNames[Counter];
        AS.clip = Food[Counter];
        AS.Play();
    }
